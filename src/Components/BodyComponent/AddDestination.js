...
export const AddDestination = () => {
    ...
    const saveDestination = (e) => {
        ...
        axios.post('http://localhost:90/destination/insert', data, { headers: { Authorization: 'Bearer ' + localStorage.getItem('admin-token') } }).then((response) => {
                ...
                <div className="row d-flex">
                    ...
                    <div className="col-lg-6">
                        <div className="card2 card border-0 px-4 py-5">
                            ...
                            <div className="row px-3"> <label className="mb-1">
                                <h6 className="mb-0 text-sm">Upload photo: </h6>
                            </label> <input className="mb-4" type="file" name="dimage" onChange={fileChange} /> </div>
